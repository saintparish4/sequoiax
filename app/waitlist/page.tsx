      ...
      <div className="flex flex-col items-center justify-center text-center max-w-[90vw] sm:max-w-[80vw] md:max-w-[70vw] gap-8">
        ...
        <div className="space-y-4">
          ...
          <p className="text-lg text-gray-600 max-w-2xl">
            Be among the first to access Sequoia - the platform revolutionizing private market investments. 
        ...
        >
          <span className="group-hover:underline group-hover:underline-offset-4">← Back to the Home</span>
        </Link>
      </div>
    </main>
  );
